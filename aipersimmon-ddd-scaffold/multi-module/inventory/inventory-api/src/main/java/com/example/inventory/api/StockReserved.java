 ...
 * {@code reservationId} handle the reacting saga must keep in order to release the very same
 * reservation later (idempotently) should the flow have to compensate.
 */
