 ...
 * cross-context contract for the stock-release compensation. The saga emits it (carrying the
 * {@code reservationId} inventory handed back on reservation) when a payment decline forces it to
