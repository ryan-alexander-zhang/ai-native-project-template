...
/**
 * Integration event published when an order is placed — the ordering context's cross-context
 * contract. It carries the ids and quantities another context needs (here, so inventory can reserve
 * stock), never the internal domain model.
 */
