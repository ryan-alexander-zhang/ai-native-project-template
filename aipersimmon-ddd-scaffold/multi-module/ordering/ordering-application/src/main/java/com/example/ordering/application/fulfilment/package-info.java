/**
 * The order-fulfilment flow's provider-agnostic contract in the application layer: the business
 * port {@link com.example.ordering.application.fulfilment.OrderFulfilmentProcess} — the stable,
 * intention-revealing entry the ordering context drives the flow through — and {@link
 * com.example.ordering.application.fulfilment.OrderFulfilmentStarter}, the application-layer
