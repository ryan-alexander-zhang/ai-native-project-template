 ...
 * each to the order id (its correlation id) plus the payload the coordinator needs, and hands off
 * to the {@link OrderFulfilmentProcess}, which holds the coordination policy. No business logic
