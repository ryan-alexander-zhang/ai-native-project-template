...
/**
 * Raised when an order's total exceeds the customer's credit limit. It carries the
 * {@link OrderingErrorCode#CREDIT_EXCEEDED} code so the interface layer renders a 422
 * problem response with a stable machine-readable code.
 */
