...
/**
 * The coarse, evidence-free classification published on {@link OrderCancelledEvent}.
 * Subscribers get to know <em>that</em> an order was cancelled and broadly why, without
 * the internal evidence refs that the aggregate used to authorise the cancellation.
 */
