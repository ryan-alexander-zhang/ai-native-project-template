 ...
 *       deterministic coordination policy ({@code ProcessDefinition});</li>
 *   <li>{@link com.example.ordering.process.fulfilment.OrderFulfilmentState} /
 *       {@link com.example.ordering.process.fulfilment.OrderFulfilmentInput} — the flow's persisted
 *       state and the facts it reacts to;</li>
 *   <li>{@link com.example.ordering.process.fulfilment.OrderFulfilmentCodecs} — the persistence
 *       codecs for state, inputs, and command effects;</li>
 *   <li>{@link com.example.ordering.process.fulfilment.RuntimeOrderFulfilmentProcess} — the
 *       runtime-backed implementation of the application's
 *       {@link com.example.ordering.application.fulfilment.OrderFulfilmentProcess} business port.</li>
 * </ul>
