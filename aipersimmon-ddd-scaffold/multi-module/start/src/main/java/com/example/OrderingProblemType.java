...
public enum OrderingProblemType implements ProblemType {
    ...
    TOO_MANY_LINES(OrderingErrorCode.TOO_MANY_LINES, "/problems/too-many-lines", 422,
            "ordering.too-many-lines.title"),
    DUPLICATE_SKU(OrderingErrorCode.DUPLICATE_SKU, "/problems/duplicate-sku", 422,
            "ordering.duplicate-sku.title"),
