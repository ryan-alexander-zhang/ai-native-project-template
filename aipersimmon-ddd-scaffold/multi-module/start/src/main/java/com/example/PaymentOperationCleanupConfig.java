...
/**
 * The retention decision for {@code payment_operations} (issue-00097).
 *
 ...
 * the log durable was argued carefully and correctly on one property, co-transactionality
 * (issue-00069); the other properties that changed with it, lifetime among them, went unexamined.
 * An unstated policy leaves no trace when it is removed.
 *
