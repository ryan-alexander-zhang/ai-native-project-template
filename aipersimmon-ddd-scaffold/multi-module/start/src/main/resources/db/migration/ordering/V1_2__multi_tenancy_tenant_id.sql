-- Pool multi-tenancy by a tenant_id discriminator column, for the ordering context.
--
...
-- Composite key for a tenant-relative natural key ------------------------
...
-- row may point at a parent in another tenant. V1_4 corrects it.
