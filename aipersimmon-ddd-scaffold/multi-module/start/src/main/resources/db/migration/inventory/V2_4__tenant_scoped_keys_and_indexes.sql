-- The two things V2_2 left behind, for the inventory context: tenant-carrying foreign keys
-- and the indexes the read paths need. The same
...
-- Part 1 — the foreign key must carry the tenant -----------------------------
