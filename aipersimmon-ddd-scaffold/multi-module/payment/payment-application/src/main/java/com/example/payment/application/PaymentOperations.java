 ...
 * makes charging an operation <em>at-most-once</em> under at-least-once delivery: the design
 * requires an irreversible action (a charge) to dedupe on its own business operation id,
 * complementing — not replacing — the transport-level effect/event id (design-00004 §13.2,
 * :283-285).
 *
