...
/**
 * The delay grows exponentially per attempt, is capped, carries jitter within a known band, and
 * never drops to zero for a positive base — the property the fixed no-spacing retry it replaces
 * lacked.
 */
