 ...
 * domain layer may name, and it must not drag a framework in (design-00012). The container half —
 * the auto-configuration that selects a dispatcher, the bound properties, the in-process dispatcher
 * and the event-type scanner — lives in {@code aipersimmon-ddd-outbox-spring-boot-starter};
 * persistence (the writer and relay) lives in a storage module.
 */
