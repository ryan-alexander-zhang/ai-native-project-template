-- Flyway migration (PostgreSQL) for the aipersimmon-ddd outbox tables. Single source of the
-- outbox schema, shared by the -outbox-jdbc and -outbox-mybatis-plus adapters. Payload/CLOB
-- become TEXT; TIMESTAMP is kept (ShedLock stores UTC via usingDbTime).
