...
/**
 * OpenTelemetry implementation of the domain-span {@link Tracer}. Each {@link #startSpan(String)}
 * opens an OTEL span as a child of the active context and makes it current for the duration, so
 * nested spine calls nest correctly along the call stack.
 */
