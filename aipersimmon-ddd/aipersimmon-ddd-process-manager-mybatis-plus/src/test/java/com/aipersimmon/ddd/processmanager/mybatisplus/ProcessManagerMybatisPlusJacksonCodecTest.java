...
class ProcessManagerMybatisPlusJacksonCodecTest {
  ...
  static class TestApp {
    ...
    ProcessSerializationCatalog processSerializationCatalog() {
      return ProcessSerializationCatalog.builder()
          .payload("starter.begin", 1, MybatisTestProcess.Begin.class)
          .payload("starter.do-thing", 1, MybatisTestProcess.DoThing.class)
          .state(
              MybatisTestProcess.TYPE,
              new StateSchemaVersion(1),
              "starter.test.state",
              MybatisTestProcess.St.class)
          .build();
    }
  ...
  @Autowired ProcessPayloadCodecRegistry payloadCodecs;
  ...
  void mapsADecodeFailureToProcessSerializationException() {
    ...
    EncodedPayload garbage =
        new EncodedPayload(
            new PayloadType("starter.begin", 1),
