...
class ProcessManagerMybatisPlusAutoConfigurationTest {

  @SpringBootConfiguration
  @EnableAutoConfiguration
  static class TestApp {
    @Bean
    ProcessDefinition<?> mybatisDefinition() {
  ...
  void startsAProcessAndTheRelayDeliversTheCommandUnderTheEffectIdentity() {
    ...
    assertEquals("order-1", ((MybatisTestProcess.DoThing) bus.commands.get(0)).reference());
  }
