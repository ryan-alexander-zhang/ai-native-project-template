...
/**
 * A well-formed {@link Invariant}: a domain rule, framework-free, plain (not a
 * Spring bean), and raised only through {@code AbstractAggregateRoot.checkInvariant} —
 * never by constructing the violation directly.
 */
