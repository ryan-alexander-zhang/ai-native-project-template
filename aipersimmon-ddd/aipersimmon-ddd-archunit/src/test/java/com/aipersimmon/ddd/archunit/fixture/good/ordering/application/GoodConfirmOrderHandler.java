...
/**
 * Well-behaved command handler: it depends inward on the domain ({@link GoodOrder})
 * and reuses shared orchestration through a non-handler application collaborator
 * ({@link GoodPlaceOrderService}) — never on another {@link CommandHandler}. This is
 * the shape {@code commandHandlersShouldNotDependOnOtherCommandHandlers} permits.
 */
