...
/**
 * A well-formed error catalogue: an enum implementing {@link ErrorCode}, so the
 * context's error codes live in one enumerated place. Exercises the good path of
 * {@code errorCodesShouldBeEnums}.
 */
