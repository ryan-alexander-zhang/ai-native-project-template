...
/**
 * A domain event declared via the {@code @DomainEvent} annotation rather than the marker interface,
 * correctly placed in the domain layer. Exercises the annotation path of the domain-event
 * containment rule.
 */
@DomainEvent
