...
/**
 * Ill-behaved command handler: it reuses orchestration by depending on <em>another</em> command
 * handler ({@link BadConfirmOrderHandler}) instead of a domain service or a non-handler application
 * collaborator — the violation {@code commandHandlersShouldNotDependOnOtherCommandHandlers}
 * catches.
 */
