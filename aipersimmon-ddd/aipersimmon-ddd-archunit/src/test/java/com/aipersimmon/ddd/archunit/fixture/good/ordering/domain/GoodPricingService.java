...
/**
 * A well-formed domain service: annotated with the core {@code @Service} and placed in
 * the domain layer, holding stateless behaviour over domain objects. Exercises the good
 * path of {@code domainServicesShouldResideInDomain}.
 */
@Service
