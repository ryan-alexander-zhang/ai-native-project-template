...
/**
 * Well-placed domain-event subscriber: it lives in the application layer, is marked
 * {@link DomainEventHandler @DomainEventHandler}, and reacts to the context's own
 * domain event — satisfying both {@code domainEventListenersShouldResideInApplicationOrDomain}
 * and {@code domainEventListenersShouldBeAnnotatedWithDomainEventHandler}.
 */
@DomainEventHandler
