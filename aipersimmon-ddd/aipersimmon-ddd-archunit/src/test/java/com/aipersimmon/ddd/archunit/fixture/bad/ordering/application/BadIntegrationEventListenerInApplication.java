...
/**
 * Violates integration-event subscriber placement: an integration-event
 * {@code @EventListener} in the application layer. Receiving a cross-context event
 * off a transport is inbound-adapter work; this belongs in the adapter layer.
 */
