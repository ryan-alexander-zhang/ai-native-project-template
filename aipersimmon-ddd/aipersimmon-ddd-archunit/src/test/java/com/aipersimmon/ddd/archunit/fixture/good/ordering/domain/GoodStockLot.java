...
/**
 * A well-formed entity: annotated {@code @Entity} and placed in the domain layer.
 * Exercises the {@code @Entity} arm of {@code domainBuildingBlocksShouldResideInDomain}.
 */
@Entity
