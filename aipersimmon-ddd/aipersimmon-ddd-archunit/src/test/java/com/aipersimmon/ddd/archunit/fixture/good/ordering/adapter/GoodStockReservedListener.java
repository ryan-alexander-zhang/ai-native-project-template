...
/**
 * Well-placed integration-event subscriber: an inbound adapter reacting to another
 * context's published event, satisfying
 * {@code integrationEventListenersShouldResideInAdapter}. It reads only the published
 * contract, so it touches no domain type.
 */
