...
/**
 * Alpha depends on the beta context only through beta's {@code ..api..} package, so it
 * respects the published-language boundary. Exercises the good path of
 * {@code boundedContextsShouldOnlyDependOnEachOthersApi}.
 */
