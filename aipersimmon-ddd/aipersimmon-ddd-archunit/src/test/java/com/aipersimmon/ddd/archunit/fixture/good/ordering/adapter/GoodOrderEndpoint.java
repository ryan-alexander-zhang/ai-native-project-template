...
/**
 * Well-behaved inbound adapter: it drives a use case through the application layer and never
 * reaches into the domain, satisfying the stricter {@code adapterShouldNotDependOnDomain} rule.
 */
