...
/**
 * Kafka header names for the <a href="https://github.com/cloudevents/spec">CloudEvents</a>
 * v1.0 Kafka binding in <em>binary content mode</em>: each CloudEvents attribute
 * travels in a {@code ce_}-prefixed header, the payload is the record value, and
 * {@code content-type} carries the data content type. Shared by the producer
 * dispatcher and the consumer bridge.
 */
