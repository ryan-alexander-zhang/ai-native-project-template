...
/**
 * Thrown when an {@link Invariant} is broken. It is a domain-rule violation, so it extends {@link
 * DomainException} and carries the invariant's {@link Invariant#errorCode()} and {@link
 * Invariant#message()}.
 */
