 ...
 *
 * <p>It may carry a stable {@link ErrorCode} so the error's machine-readable identity
 * is fixed at the point it is thrown and can travel unchanged to the edge. The code
 * is optional: the message-only constructors remain for errors that do not need one.
 */
