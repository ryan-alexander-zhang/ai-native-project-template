...
/**
 * Redis-backed {@link IdempotencyStore}: the first response is stored as JSON under
 * a per-key entry with a native TTL, and {@link #saveIfAbsent} uses {@code SET NX}
 * for atomic first-writer-wins across instances.
 */
