...
/**
 * Redis-backed {@link ReplayGuard}: {@code SET NX} with a TTL records a nonce on
 * first sight; a failed set (the key already exists) means the nonce was seen
 * before. The single-use guarantee holds across instances.
 */
