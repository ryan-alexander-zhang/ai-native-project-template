...
/**
 * Wires the Redis-backed web stores once a {@code StringRedisTemplate} is present. Each bean is
...
public class AipersimmonDddWebStoreRedisAutoConfiguration {
  ...
  public IdempotencyStore redisIdempotencyStore(
      StringRedisTemplate redis, ObjectProvider<ObjectMapper> objectMapper) {
