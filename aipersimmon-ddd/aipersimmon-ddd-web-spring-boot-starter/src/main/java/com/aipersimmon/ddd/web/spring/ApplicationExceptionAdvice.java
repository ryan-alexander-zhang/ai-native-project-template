 ...
 * EntityNotFoundException} to 404, {@link ConcurrencyConflictException} and {@link
 * DuplicateEntityException} to 409, and the base {@link ApplicationException} (a use-case
 * orchestration failure that is not a domain-rule violation) to 422. Each honours an {@link
 * com.aipersimmon.ddd.core.error.ErrorCode} the exception carries, resolving it through the
 * registry. Registered only when {@code aipersimmon-ddd-application} is on the classpath.
 */
