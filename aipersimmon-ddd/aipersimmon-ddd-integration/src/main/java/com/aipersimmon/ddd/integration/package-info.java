 ...
 *
 * <p>Its logical identity is declared with {@link com.aipersimmon.ddd.integration.EventType}
 * and its transport <em>reach</em> with {@link com.aipersimmon.ddd.integration.Externalized}:
 * an event is LOCAL (in-process only) by default and EXTERNAL (routed to a named broker
 * target) only when explicitly annotated. Keeping these two as separate annotations holds
 * the line between contract identity and deployment concern.
 */
