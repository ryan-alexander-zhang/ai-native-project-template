...
ALTER TABLE aipersimmon_process_transition DROP COLUMN trace_id;
ALTER TABLE aipersimmon_process_effect DROP COLUMN trace_id;
ALTER TABLE aipersimmon_process_deadline DROP COLUMN trace_id;
