...
-- take tenant_id as a plain data/predicate column and keep their existing constraints.
ALTER TABLE aipersimmon_process_instance DROP CONSTRAINT IF EXISTS uq_process_instance_business;
