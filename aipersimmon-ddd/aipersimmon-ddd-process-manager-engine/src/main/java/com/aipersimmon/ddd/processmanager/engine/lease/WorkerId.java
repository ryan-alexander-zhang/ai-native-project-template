...
/**
 * The lease identity of a worker node — used only to own a claim, never a business identity. Set
 * explicitly for a deployment, or generated per process when unset.
 *
