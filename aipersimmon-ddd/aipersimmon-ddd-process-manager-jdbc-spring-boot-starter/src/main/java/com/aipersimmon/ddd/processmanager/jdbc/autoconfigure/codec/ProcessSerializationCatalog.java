 ...
 * {@code ProcessStateCodec} beans instead of using this catalog.
 */
public final class ProcessSerializationCatalog {
    ...
    public record StateEntry(ProcessType processType, StateSchemaVersion schemaVersion,
    ...
    public static final class Builder {
        ...
        public Builder state(ProcessType processType, StateSchemaVersion schemaVersion,
                String logicalType, Class<?> javaType) {
            states.add(new StateEntry(processType, schemaVersion,
                    new PayloadType(logicalType, schemaVersion.value()), javaType));
            return this;
        }
