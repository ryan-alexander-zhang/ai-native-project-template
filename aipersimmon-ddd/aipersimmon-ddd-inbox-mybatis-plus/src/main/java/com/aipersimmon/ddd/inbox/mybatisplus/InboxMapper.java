...
/**
 * MyBatis-Plus mapper for {@link InboxRecord}. Only the inherited {@code insert} is used —
 * recording a handled key. It is registered explicitly by this module's auto-configuration (a
