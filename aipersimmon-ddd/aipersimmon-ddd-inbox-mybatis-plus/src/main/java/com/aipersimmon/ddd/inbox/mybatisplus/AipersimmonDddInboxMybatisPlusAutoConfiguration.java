 ...
 * {@code Inbox} bean. Retention cleanup is opt-in via
 * {@code aipersimmon.ddd.inbox.cleanup.enabled=true}.
 */
...
public class AipersimmonDddInboxMybatisPlusAutoConfiguration {
    ...
    static class InboxCleanupConfiguration {
        ...
        @ConditionalOnMissingBean
        public InboxCleanup inboxCleanup(InboxMapper inboxMapper, Clock inboxClock,
