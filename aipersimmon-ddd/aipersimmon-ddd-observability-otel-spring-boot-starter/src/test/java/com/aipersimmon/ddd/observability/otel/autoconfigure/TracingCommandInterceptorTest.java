...
/**
 * Verifies the command span the interceptor adds — the auto-instrumentation cannot see the in-house
 * command bus, so this span is what makes "which command ran" visible.
 */
