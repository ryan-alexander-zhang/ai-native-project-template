...
/**
 * In-memory {@link IdempotencyStore} for single-node and development use. Entries expire lazily on
 * read. Not suitable for multiple instances — use a store backend module ({@code
 * -web-store-redis}/{@code -web-store-jdbc}) in production, which replaces this bean.
 */
