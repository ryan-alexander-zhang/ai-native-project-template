...
/**
 * Translates the framework-free {@link ApiError} value model into Spring's
 * {@link ProblemDetail} wire type. The extension members ({@code code},
 * {@code traceId}, {@code errors}) become problem-detail properties; the standard
 * members map one-to-one. Keeping this translation here is what lets the
 * {@code -web} tier stay independent of Spring.
 */
