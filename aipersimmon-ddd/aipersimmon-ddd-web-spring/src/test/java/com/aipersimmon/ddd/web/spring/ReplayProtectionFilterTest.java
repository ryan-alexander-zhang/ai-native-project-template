...
/**
 * With replay protection enabled (signature + timestamp tolerance + nonce dedup),
 * a well-formed fresh request passes, while a bad signature, a stale timestamp, or
 * a reused nonce are rejected with 401.
 */
@SpringBootTest(classes = ReplayProtectionFilterTest.Config.class, properties = {
