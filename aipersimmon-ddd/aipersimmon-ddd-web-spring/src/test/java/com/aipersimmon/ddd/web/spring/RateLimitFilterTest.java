...
/**
 * With a rate limit of one request per window, the second request is rejected with
 * 429, a Retry-After, RateLimit headers, and a problem body.
 */
@SpringBootTest(classes = RateLimitFilterTest.Config.class, properties = {
...
class RateLimitFilterTest {
    ...
    void firstRequestAllowedSecondRejectedWith429() throws Exception {
        ...
        mvc.perform(get("/rl"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("/problems/rate-limited")));
    }
