 ...
 */
class JdbcWebStoreCleanupTest {

  private static final Instant NOW = Instant.parse("2026-07-30T12:00:00Z");

  private JdbcTemplate jdbc;
  private JdbcWebStoreCleanup cleanup;
  ...
  void setUp() {
    ...
    cleanup = new JdbcWebStoreCleanup(jdbc, Clock.fixed(NOW, ZoneOffset.UTC), Duration.ofHours(24));
  }
