 ...
 */
class JdbcProcessRetentionStoreTest {
  ...
  private JdbcProcessRetentionStore retention;
  ...
  void setUp() {
    ...
    retention = new JdbcProcessRetentionStore(jdbc);
    instances = new JdbcProcessInstanceStore(jdbc);
    transitions = new JdbcProcessTransitionStore(jdbc);
