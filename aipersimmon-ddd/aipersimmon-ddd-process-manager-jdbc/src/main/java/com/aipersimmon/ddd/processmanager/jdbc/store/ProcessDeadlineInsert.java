...
/**
 * One scheduled deadline generation to persist as {@code PENDING}. A reschedule of the same name
 * uses a higher {@code generation}, so a late fire of an older generation is a no-op. The encoded
