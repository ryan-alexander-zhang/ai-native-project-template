...
/**
 * The current snapshot of an instance as read from {@code aipersimmon_process_instance}.
 * The encoded state is exposed as its logical payload type plus raw bytes, which the
 * runtime hands to the state codec to decode; the byte array is defensively copied.
 */
