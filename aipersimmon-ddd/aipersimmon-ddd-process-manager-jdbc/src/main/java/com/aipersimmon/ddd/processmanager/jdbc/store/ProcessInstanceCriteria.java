...
public record ProcessInstanceCriteria(
    ...
    public ProcessInstanceCriteria withProcessType(ProcessType value) {
        return new ProcessInstanceCriteria(Optional.of(value), businessKey, lifecycle, step, definitionVersion);
    }

    public ProcessInstanceCriteria withBusinessKey(ProcessBusinessKey value) {
        return new ProcessInstanceCriteria(processType, Optional.of(value), lifecycle, step, definitionVersion);
    }

    public ProcessInstanceCriteria withLifecycle(ProcessLifecycle value) {
        return new ProcessInstanceCriteria(processType, businessKey, Optional.of(value), step, definitionVersion);
    }

    public ProcessInstanceCriteria withStep(ProcessStep value) {
        return new ProcessInstanceCriteria(processType, businessKey, lifecycle, Optional.of(value), definitionVersion);
    }

    public ProcessInstanceCriteria withDefinitionVersion(DefinitionVersion value) {
        return new ProcessInstanceCriteria(processType, businessKey, lifecycle, step, Optional.of(value));
    }
}
