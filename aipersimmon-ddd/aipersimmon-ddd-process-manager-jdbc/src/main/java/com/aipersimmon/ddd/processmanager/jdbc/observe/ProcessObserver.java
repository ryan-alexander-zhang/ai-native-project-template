 ...
 *
 * <p>Backlog gauges (dead counts, oldest-pending age, suspended/stuck instances) are pull-based
 * and read on demand via {@link JdbcProcessBacklog}; they are not reported through this hook.
 */
public interface ProcessObserver {
    ...
    ProcessObserver NOOP = new ProcessObserver() {
        @Override
