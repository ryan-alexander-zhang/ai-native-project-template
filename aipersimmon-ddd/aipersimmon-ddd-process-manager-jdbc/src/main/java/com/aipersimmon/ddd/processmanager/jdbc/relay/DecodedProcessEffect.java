...
/**
 * A staged effect whose payload the relay has decoded back to its Java form (a
 * {@code Command} or an {@code IntegrationEvent}), ready for a dispatcher. The relay
 * dispatches it under the reconstructed {@code CommandContext} whose {@code messageId}
 * is this effect's stable id.
 *
