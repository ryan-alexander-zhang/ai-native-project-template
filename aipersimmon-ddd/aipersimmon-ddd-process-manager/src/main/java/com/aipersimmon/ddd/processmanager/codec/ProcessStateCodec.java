...
/**
 * Encodes and decodes the business state of one {@link ProcessType} at one {@link
 * StateSchemaVersion}. A running instance keeps decoding under the schema it was written with; a
 * schema upgrade is an explicit new codec (with an upcaster), never a decode-failure-then-reopen.
 *
