...
public final class UnknownProcessDefinitionException extends ProcessException {
    ...
    public UnknownProcessDefinitionException(ProcessType processType, DefinitionVersion definitionVersion) {
        super("no process definition registered for type " + processType.value()
