...
/**
 * Effect asking the runtime to cancel the current generation of the named timer
 * {@code name}. It does not cancel a generation armed by a later
 * {@link ScheduleDeadline}.
 *
