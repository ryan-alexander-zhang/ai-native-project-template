...
/**
 * The full runtime handle of a process instance: its {@link ProcessInstanceId} plus
 * the {@link ProcessType} and {@link ProcessBusinessKey} it was started for. The
 * runtime's {@code handle} addresses an existing instance by this whole reference
 * rather than guessing an instance from a business key.
 *
