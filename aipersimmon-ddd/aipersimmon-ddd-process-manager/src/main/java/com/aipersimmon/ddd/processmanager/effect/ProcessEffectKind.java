...
/**
 * The kind of a {@link ProcessEffect}, used by a runtime to route each effect to the
 * one dispatcher registered for it. Distinct from the effect's Java type so a runtime
 * can index dispatchers without a {@code instanceof} cascade.
 */
