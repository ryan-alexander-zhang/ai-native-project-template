...
/**
 * The committed result of a {@code start} or {@code handle}: the instance reference, its new
 * revision, lifecycle and step, whether this call was a duplicate (a no-op that returned the
 * original transition's outcome), and the id of the transition it produced.
 *
