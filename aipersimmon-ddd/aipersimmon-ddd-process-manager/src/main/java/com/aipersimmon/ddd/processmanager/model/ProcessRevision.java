...
/**
 * The optimistic-concurrency version of a process instance. It expresses only the write generation
 * used to admit exactly one transition at a time; it is not part of the business state and never
 * enters a state object. A fresh instance starts at {@link #initial()} and advances by {@link
 * #next()} on each committed transition.
 *
