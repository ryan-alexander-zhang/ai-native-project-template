...
/**
 * Encodes and decodes one payload type — a command, a deadline input, or an integration-event body
 * — between its Java form and an {@link EncodedPayload}. Codecs are registered explicitly by the
 * consumer; the runtime never reflects over business classes. An implementation may use JSON, Avro,
 * Protobuf, or add encryption; the contract does not depend on any of them.
 *
