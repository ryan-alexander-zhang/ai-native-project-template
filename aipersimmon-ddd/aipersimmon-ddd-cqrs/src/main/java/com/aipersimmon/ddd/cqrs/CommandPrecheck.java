 ...
 * and one slow dependency amplifies into an exhausted connection pool. The bus runs prechecks
 * between validation and the transaction interceptor, so a refusal costs no connection at all.
 *
