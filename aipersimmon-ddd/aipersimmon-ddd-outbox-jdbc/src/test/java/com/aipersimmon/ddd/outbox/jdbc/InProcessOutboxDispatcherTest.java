...
/**
 * Verifies mode 2 (in-process asynchronous): with the in-process dispatcher enabled, the relay
 * reconstructs the stored event and republishes it to a local {@code @EventListener}.
 */
@SpringBootTest(
