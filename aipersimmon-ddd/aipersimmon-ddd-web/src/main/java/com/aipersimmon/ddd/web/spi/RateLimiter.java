...
/**
 * Decides whether a request may proceed under a {@link RateLimitPolicy}, consuming
 * one unit of quota for the given key (typically derived from client IP, user, or
 * API key). A rejected decision drives a {@code 429} response with
...
public interface RateLimiter {
     ...
     * @param retryAfter how long the caller should wait before retrying (meaningful
     *                   when {@code allowed} is false); may be {@link Duration#ZERO}
     */
