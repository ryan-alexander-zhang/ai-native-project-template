...
/**
 * A rate-limit quota: at most {@code limit} requests per {@code window}, under a
 * named policy. The name is echoed in the {@code RateLimit}/{@code RateLimit-Policy}
 * response headers so a client can tell which quota it hit.
 *
