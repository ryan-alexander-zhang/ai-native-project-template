...
/**
 * A captured HTTP response, stored by an {@link IdempotencyStore} so a replayed request with the
 * same idempotency key can be answered with the original outcome.
 *
