...
/**
 * A cursor-based page of results: the {@code items} plus an optional
 * {@code nextCursor}. It carries no total count — the default, cheapest shape, and
 * the one large APIs favour. A null {@code nextCursor} means there is no next page.
 *
