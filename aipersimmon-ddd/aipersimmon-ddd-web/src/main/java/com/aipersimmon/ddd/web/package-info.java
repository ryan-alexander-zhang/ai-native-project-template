 ...
 *
 * <p>The library takes the "no envelope" stance: a successful response returns the
 * resource directly with the correct HTTP status code, and a failure is expressed
 * as an RFC 9457 problem document. This package holds the vocabulary a REST adapter
 ...
 *       backend must hold: idempotency, replay protection, rate limiting, and
 *       request-signature verification.</li>
 * </ul>
 *
 * <p>A Spring starter implements these ports; pluggable Redis/JDBC backends
 * implement the SPIs. Nothing here depends on Spring, Jackson, or the servlet API.
 */
