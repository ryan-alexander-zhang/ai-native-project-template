...
/**
 * A page of results that also reports totals — the offset-compatible shape for the
 * cases that genuinely need a total count or page count. Prefer {@link Slice} when
 * totals are not required, since counting is often the expensive part of a query.
 *
