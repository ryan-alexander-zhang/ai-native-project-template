...
-- the sentinel default so single-tenant (N=1) and pre-existing rows stay valid and unique. In
-- PostgreSQL the implicit primary-key constraint is named <table>_pkey.
...
ALTER TABLE aipersimmon_web_nonce DROP CONSTRAINT aipersimmon_web_nonce_pkey;
...
ALTER TABLE aipersimmon_web_rate_limit DROP CONSTRAINT aipersimmon_web_rate_limit_pkey;
