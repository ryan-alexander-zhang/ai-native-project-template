...
/**
 * Proves that adding this starter auto-configures Spring-backed publishers for
 * both event kinds (the outbox starter is not on this module's classpath, so the
 * in-process integration publisher applies).
 */
