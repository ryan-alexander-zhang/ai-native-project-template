...
public interface Inbox {
  ...
  /**
   * Record the given message key as handled and report whether it had already been handled.
   *
   * @return {@code true} if the key was already recorded (skip processing); {@code false} if this
