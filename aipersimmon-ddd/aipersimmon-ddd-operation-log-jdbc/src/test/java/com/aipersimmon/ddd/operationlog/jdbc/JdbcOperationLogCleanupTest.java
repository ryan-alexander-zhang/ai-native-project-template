 ...
 */
class JdbcOperationLogCleanupTest {
  ...
  void removesOnlyRecordsPastTheRetentionWindow() {
    ...
    new JdbcOperationLogCleanup(jdbc, Clock.fixed(NOW, ZoneOffset.UTC), 3600, 500).purge();
  ...
  void aBacklogLargerThanOnePageDrainsInOneRunByLoopingPages() {
    ...
    new JdbcOperationLogCleanup(jdbc, Clock.fixed(NOW, ZoneOffset.UTC), 3600, 1).purge();
