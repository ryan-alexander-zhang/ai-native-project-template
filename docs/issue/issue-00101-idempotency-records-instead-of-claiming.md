...
- 后续：[issue-00172-the-idempotency-fingerprint-does-not-cover-the-body](issue-00172-the-idempotency-fingerprint-does-not-cover-the-body.md)（推翻本 issue "fingerprint 不含请求体"的取舍：body 进指纹，有界缓冲兜 DoS）
