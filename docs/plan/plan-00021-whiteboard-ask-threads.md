...
- **T2 — 既有文档交接修订轮**（各归各的修订轮，逐份走
  ...
  - `spec-00001`：FR-47 改写为向 `spec-00005` 的交接（答疑不再是
    终端会话，`spec-00001-AC-47.1` … `AC-47.5` 改写或移交，Story S9
    价值句改写）；FR-14 移除「答疑一会话一 commit」半句且
    `spec-00001-AC-14.7` 连同其测试移除；FR-18 与
  ...
  - `spec-00004`：FR-2 等待通知的派生不适用、FR-5 点击呈现的答疑
    分支登记交接。
  - `rule-00001`：BR-21 改写为只读问答，`rule-00001-AC-21.3` 移除。
